...
def main() -> int:
    ...
    print("     2) Claude Desktop 에서 **새 대화**를 열고 PROMPT_D.txt 를 붙여넣기")
    print("     (서버가 활성 도면을 추종하므로 재시작은 불필요하다)")
    print()
    print("  ⚠ 시행 중에는 Civil 3D 를 건드리지 말 것 — 도면이 바뀌면 서버가 따라간다.")
    return 0
